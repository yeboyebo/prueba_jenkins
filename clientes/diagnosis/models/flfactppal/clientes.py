...
# @class_declaration yeboyebo_clientes #
class yeboyebo_clientes(interna_clientes, helpers.MixinConAcciones):
    pass
...
class clientes(yeboyebo_clientes, helpers.MixinConAcciones):
    pass
